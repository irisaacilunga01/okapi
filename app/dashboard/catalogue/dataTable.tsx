...
import { Chambre as Payment } from "@/lib/types";
...
import { deleteChambre, deleteUser } from "@/lib/actions";
            ...
            <DropdownMenuContent align="end" className="pr-10 py-2">
              ...
              <DropdownMenuItem>
                <Link
                  ...
                  href={`/dashboard/catalogue/ajouter`}
                >
              ...
              <DropdownMenuItem>
                <Link
                  className="flex gap-3"
                  href={`/dashboard/catalogue/${row.original.id}`}
                >
          ...
          <DialogContent>
            ...
            <DialogFooter className="justify-end">
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    await deleteChambre(row.original.id);
                    toast({
                      title: "Supprimer",
                      description: `le client ${row.original.id}  a été supprimer avec succès`,
                      className: "bg-green-700 text-white",
                    });
                  } catch (error) {
                    toast({
                      title: "Erreur supprimer",
                      description: `Erreur lors de la suppression de la catalogue`,
